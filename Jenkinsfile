    ...
    stages {
            stage ('Checkout') {
                steps {
                    ...
                    sh "cp /Users/aplanetbit/StudioProjects/dict_insurance/android/key.properties /Users/aplanetbit/.jenkins/workspace/Dictionary of Insurance/android/key.properties"
                }
            }
